            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 overflow-hidden">
                        <h4 class="main-title">{{ $cate_slug->title }}</h4>
                                ...
                                @foreach ($movie as $key => $mov)
                                    <li class="slide-item">
                                        <div class="block-images position-relative">
                                            <div class="img-box">
                                                <img src="{{ asset('uploads/movie/' . $mov->image) }}" class="img-fluid" alt="">
                                            </div>
                                            <div class="block-description">
                                                <h6 class="iq-title">
                                                    <a href="{{ route('movie', $mov->slug) }}">{{ $mov->title }}</a>
                                                </h6>
                                                    ...
                                                    <li class="share">
                                                        ...
                                                        <div class="share-box">
                                                            <div class="d-flex align-items-center">
                                                                <a href="https://www.facebook.com/sharer?u={{ route('movie', $mov->slug) }}" target="_blank" rel="noopener noreferrer" class="share-ico" tabindex="0"><i class="ri-facebook-fill"></i></a>
                                                                <a href="https://twitter.com/intent/tweet?text={{ $mov->title }}" target="_blank" rel="noopener noreferrer" class="share-ico" tabindex="0"><i class="ri-twitter-fill"></i></a>
                                                                <a href="#" data-link="{{ route('movie', $mov->slug) }}" class="share-ico iq-copy-link" tabindex="0"><i class="ri-links-fill"></i></a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                            ...
                            <ul class="favorites-slider list-inline row p-0 mb-0">
                                ...
                                <li class="slide-item">
                                    <div class="block-images position-relative">
                                        ...
                                        <div class="block-description">
                                            <h6 class="iq-title"><a
                                                    href="{{ route('movie', $hot->slug) }}">{{ $hot->title }}</a></h6>
                                            ...
                                            <div class="movie-time d-flex align-items-center my-2">
                                                ...
                                                <span class="text-white">{{ $hot->thoiluong }}</span>
                                            </div>
                                            <div class="hover-buttons">
                                                @if(Session::get('customer_id'))
