...
(function (jQuery) {
	...
	jQuery(document).ready(function() {
		...
		jQuery('#tvshows-slider').slick({
			...
			centerPadding: '200px',
			slidesToShow: 1,
			nextArrow: '<button class="NextArrow"><img src="/images/icon/caret-right.svg" alt="Next Arrow" width="160" height="160"></button>',
			prevArrow: '<button class="PreArrow"><img src="/images/icon/caret-left.svg" alt="Previous Arrow" width="160" height="160"></button>',
